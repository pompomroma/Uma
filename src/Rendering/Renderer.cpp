...
Renderer::Mesh Renderer::createCubeMesh(float size) {
    ...
    std::vector<Vertex> vertices = {
        // Front face
        Vertex(Vector3(-halfSize, -halfSize,  halfSize), Vector3(0, 0, 1), Vector3(1, 0, 0), Vector3(0, 0, 0)),
        Vertex(Vector3( halfSize, -halfSize,  halfSize), Vector3(0, 0, 1), Vector3(0, 1, 0), Vector3(1, 0, 0)),
        Vertex(Vector3( halfSize,  halfSize,  halfSize), Vector3(0, 0, 1), Vector3(0, 0, 1), Vector3(1, 1, 0)),
        Vertex(Vector3(-halfSize,  halfSize,  halfSize), Vector3(0, 0, 1), Vector3(1, 1, 0), Vector3(0, 1, 0)),
        
        // Back face
        Vertex(Vector3(-halfSize, -halfSize, -halfSize), Vector3(0, 0, -1), Vector3(1, 0, 1), Vector3(0, 0, 0)),
        Vertex(Vector3( halfSize, -halfSize, -halfSize), Vector3(0, 0, -1), Vector3(0, 1, 1), Vector3(1, 0, 0)),
        Vertex(Vector3( halfSize,  halfSize, -halfSize), Vector3(0, 0, -1), Vector3(1, 1, 1), Vector3(1, 1, 0)),
        Vertex(Vector3(-halfSize,  halfSize, -halfSize), Vector3(0, 0, -1), Vector3(0, 0, 0), Vector3(0, 1, 0)),
    };
...
Renderer::Mesh Renderer::createPlaneMesh(float width, float height) {
    ...
    std::vector<Vertex> vertices = {
        Vertex(Vector3(-halfWidth, 0, -halfHeight), Vector3(0, 1, 0), Vector3(1, 1, 1), Vector3(0, 0, 0)),
        Vertex(Vector3( halfWidth, 0, -halfHeight), Vector3(0, 1, 0), Vector3(1, 1, 1), Vector3(1, 0, 0)),
        Vertex(Vector3( halfWidth, 0,  halfHeight), Vector3(0, 1, 0), Vector3(1, 1, 1), Vector3(1, 1, 0)),
        Vertex(Vector3(-halfWidth, 0,  halfHeight), Vector3(0, 1, 0), Vector3(1, 1, 1), Vector3(0, 1, 0))
    };
